...
export const MOCK_DASHBOARD: DashboardPayload = {
  ...
  kpis: {
    ...
    ordersBreakdown: { prevYear: 28, prevYearFull: 42, thisQuarter: 10, lastMonth: 4, lastMonthName: 'Feb', bestMonth: { name: 'Sep', value: 6 } },
    avgOrderBreakdown: { prevYear: 7636, prevYearFull: 6800, thisQuarter: 6840, lastMonth: 5250, lastMonthName: 'Feb', bestMonth: { name: 'Jan', value: 8500 } },
    marginPercentBreakdown: { prevYear: 19.6, prevYearFull: 18.8, thisQuarter: 17.2, lastMonth: 16.1, lastMonthName: 'Feb', bestMonth: { name: 'Jul', value: 22.3 } },
    marginAmountBreakdown: { prevYear: 41900, prevYearFull: 53700, thisQuarter: 11770, lastMonth: 3381, lastMonthName: 'Feb', bestMonth: { name: 'Sep', value: 6500 } },
    frequencyBreakdown: { prevYear: 2.3, prevYearFull: 3.5, thisQuarter: 3.3, lastMonth: 4, lastMonthName: 'Feb', bestMonth: { name: 'Sep', value: 5 } },
  },
  monthlyRevenue: [
