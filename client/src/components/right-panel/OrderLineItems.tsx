...
export function OrderLineItems({ items }: OrderLineItemsProps) {
  if (items.length === 0) {
    return (
      <div className="ml-[var(--spacing-3xl)] mr-[var(--spacing-base)] my-[var(--spacing-sm)] border-l-[1.5px] border-l-[var(--color-gold-muted)] py-[var(--spacing-base)] pl-[var(--spacing-3xl)]">
  ...
  return (
    <div className="ml-[var(--spacing-3xl)] mr-[var(--spacing-base)] my-[var(--spacing-sm)] border-l-[1.5px] border-l-[var(--color-gold-muted)] overflow-x-auto">
