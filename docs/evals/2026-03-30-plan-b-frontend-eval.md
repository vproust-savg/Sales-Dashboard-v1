...
**Scope for this plan:**
- Smoke test: Quick Smoke Test above (8 checks)
- Full eval: Sections 1-6 (60 checks)
- Convergence: All Critical PASS, High allows max 1 FAIL with documented fix plan

**Fix agent file scope:** `client/src/**`
**Fix agent read-only:** `shared/**`
**Fix agent spec sections:** 1-4, 8, 9, 12, 20-25
